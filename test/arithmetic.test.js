...
// TODO: Challenge #1
    describe('Subtraction', function () {
        it('subtracts two positive integers', function (done) {
            request.get('/arithmetic?operation=subtract&operand1=21&operand2=19')
                .expect(200)
                .end(function (err, res) {
        ...
        it('subtracts a positive integer from a smaller positive integer', function (done) {
    ...
    describe('Power', function () {
        ...
        it('calculates power with base 10', function (done) {
        ...
        it('calculates power with exponent 0', function (done) {
        ...
        it('calculates power with base 0', function (done) {
        ...
        it('calculates power with negative base and even exponent', function (done) {
        ...
        it('calculates power with negative base and odd exponent', function (done) {
        ...
        it('calculates power with floating point numbers', function (done) {
